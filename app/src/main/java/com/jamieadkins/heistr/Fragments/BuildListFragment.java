...
public class BuildListFragment extends Fragment implements NewBuildDialog.NewBuildDialogListener, RenameDialog.RenameDialogListener {
    ...
    public final static String EXTRA_BUILD_INFAMIES = "com.jamieadkins.heistr.INFAMIES";
    public final static String EXTRA_BUILD_URL = "com.jamieadkins.heistr.URL";
    public final static String EXTRA_BUILD_TEMPLATE = "com.jamieadkins.heistr.TEMPLATE";
