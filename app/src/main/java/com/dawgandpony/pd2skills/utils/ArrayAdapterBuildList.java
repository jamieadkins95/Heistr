...
public class ArrayAdapterBuildList extends ArrayAdapter<Build>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvPrimaryAccuracy.setText(getItem(position).getWeaponBuild().getPrimaryWeapon().getBaseAccuracy() + "");
        tvPrimaryStability.setText(getItem(position).getWeaponBuild().getPrimaryWeapon().getBaseStability() + "");
        tvPrimaryConcealment.setText(getItem(position).getWeaponBuild().getPrimaryWeapon().getBaseConcealment() + "");
        ...
        tvSecondaryAccuracy.setText(getItem(position).getWeaponBuild().getSecondaryWeapon().getBaseAccuracy() + "");
        tvSecondaryStability.setText(getItem(position).getWeaponBuild().getSecondaryWeapon().getBaseStability() + "");
        tvSecondaryConcealment.setText(getItem(position).getWeaponBuild().getSecondaryWeapon().getBaseConcealment() + "");
